	...
	<table
		...
		<tr>
			...
			<td align="center" style="width: 300px">
				<!-- 방만들기 / 방나가기 버튼 --> <input type="button" class="ui button "
				value="방 만들기" id="createRoom"> &nbsp;&nbsp; <input
				type="button" class="ui button " value="전체 채팅방으로 이동" id="backBtn">
			</td>
		</tr>
	</table>
	<!-- 채팅방 구현하기위한 테이블 -->
			...
			<td style="width: 300px">
				...
				<form action="MoveChatRoom.do" method="post" id="moveChatForm">
					...
					<div class="ui message blue"
						style="width: 300px; height: 100px; overflow-y: scroll; overflow-x: inherit;"
						id="room">
						<!-- 전체 채팅방 -->
				...
				</form> <input type="text" class="ui input blue"
				style="width: 200px; height: 32px" placeholder="방 제목"
				id="searchRoomText"> &nbsp;&nbsp;&nbsp; <input type="button"
				value="검색" class="ui primary button"
				style="width: 80px; height: 30px" id="searchRoomBtn"> <!-- 방만들기 form이용 -->
					...
					<div style="width: 300px; height: 500px; display: none;"
						...
						<table style="width: 100%; height: 100%">
							...
							<tr style="padding: 1px; margin: 1px">
								<th>방제목</th>
								<td><input type="text" name="name" placeholder="방이름"
									size="8" class="ui message"
	...
	$(document)
			.ready(
					function() {
						...
						if (id == 'admin') {
							ws = new WebSocket(
									"ws://localhost:8090/FinalProject/echo.do");
						}

						// 그 외 회원은 admin을 제외한 다른 아이디로 접속 시, 채팅참여가 가능하다.
						else {
							ws = new WebSocket(
									"ws://192.168.0.146:8040/hpot/echo.do");
						}
